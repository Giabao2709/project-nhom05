    ...
    <table border="1" style="width:100%; border-collapse: collapse; text-align:left;">
        ...
        <tbody>
            <?php if (empty($ds_dondattour)): ?>
                <tr>
                    <td colspan="7" style="text-align:center; padding:20px;">Chưa có đơn đặt tour nào.</td>
                </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php 
                                ...
                                $color = ($status == 'Mới') ? 'blue' :
                                         (($status == 'Đã hủy') ? 'red' : 'green');
                        ...
                        <td>
                            ...
                            <a href="index.php?module=dondattour&action=delete&id=<?php echo $dd['ma_booking']; ?>" 
